...
const socket=io("ws://54.152.22.112:8900") 
sb="http://54.152.22.112/"
...
function getallnotifications(){
    ...
    $("#addnewnotifications").fadeOut("fast")
    $("#divnotifications").fadeIn("fast")
}
function backtonewnotifications(){
    $("#divnotifications").fadeOut("fast")
    $("#addnewnotifications").fadeIn("fast")
}
...
function accept(data){
    ...
    $("#acceptsss").fadeOut("fast")
    $("#rejectsss").fadeOut("fast")
    timer2=setTimeout(()=>{
        $("#message").fadeIn("fast")
    },1000)
}
